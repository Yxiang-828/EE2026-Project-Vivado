...
#
# Generated by export_simulation on Sat Nov 08 20:53:21 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './blk_mem_gen_pow2.sh' script.

./blk_mem_gen_pow2.sh -reset_run
...
./blk_mem_gen_pow2.sh -noclean_files

For more information on the script, please type './blk_mem_gen_pow2.sh -help'.
