...
#
# Generated by export_simulation on Sat Nov 08 16:32:37 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './divider_generator_0.sh' script.

./divider_generator_0.sh -reset_run
...
./divider_generator_0.sh -noclean_files

For more information on the script, please type './divider_generator_0.sh -help'.
