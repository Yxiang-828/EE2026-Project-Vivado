...
module data_parser (
    ...
    always @(posedge clk) begin
        if (reset) begin
            ...
            is_left_paren <= (key_valid && key_code == 5'b11011);
            is_right_paren <= (key_valid && key_code == 5'b11100);
            is_equals <= (key_valid && key_code == 5'b11001);
            clear_request <= (key_valid && key_code == 5'b11010);
        end
    end
